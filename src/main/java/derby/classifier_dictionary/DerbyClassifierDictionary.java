package derby.classifier_dictionary;
...
public class DerbyClassifierDictionary {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RandomForestClassifier.classify(trainingSet, testSet, "derby_dictionary");

        NaiveBayesClassifier.classify(trainingSet, testSet, "derby_dictionary");

        SVMClassifier.classify(trainingSet, testSet, "derby_dictionary");
    ...
    public static Instances loadDataset(String path) {
        ...
        try {
            ...
            Logger.getLogger(DerbyClassifierDictionary.class.getName()).log(Level.SEVERE, null, ex);
        }
