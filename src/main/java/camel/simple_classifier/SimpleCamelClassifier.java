package camel.simple_classifier;
...
public class SimpleCamelClassifier {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RandomForestClassifier.classify(trainingSet, testSet, "camel_simple");

        NaiveBayesClassifier.classify(trainingSet, testSet, "camel_simple");

        SVMClassifier.classify(trainingSet, testSet, "camel_simple");
    ...
    public static Instances loadDataset(String path) {
        ...
        try {
            ...
            Logger.getLogger(SimpleCamelClassifier.class.getName()).log(Level.SEVERE, null, ex);
        }
