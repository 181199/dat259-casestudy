...
public class CamelWord2VecClassifier {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try (RecordReader recordReader = new CSVRecordReader(1, ';')) {
            ...
            recordReader.initialize(new FileSplit(new ClassPathResource("camel_wordvec.csv").getFile()));
        ...
        SplitTestAndTrain testAndTrain = allData.splitTestAndTrain(0.50);
