 ...
 *
 */
public class CamelDataPreProcess {

	/**
	 * 
	 */
	public CamelDataPreProcess() {
	...
	public static void main(String[] args) throws Exception {
		...
		loadFileToARFF();
		// Get data
		Instances data = new Instances(new FileReader("./dataset/camel.arff"));
	    ...
	    instancesToCsv(dataFiltered, "./dataset/camel_tokenized.csv");
	...
	private static void loadFileToARFF() {
		...
		File out = new File("./dataset/camel.arff");
		File fin = new File("./dataset/camel_mod.csv");
		
		String header = "@RELATION 'camel-security'\n" +
				"\n" + 
